...
if (isset($_POST['btnDelete'])) {
    ...
    $deleteQuery = "DELETE FROM usersinfo WHERE userInfoID= '$userInfoID'";
                                ...
                                <div class="container-fluid d-flex justify-content-start">
                                    <div class="row mt-5 w-100">
                                        <div class="col-12 text-start">
                                            ...
                                            <form method="post">
                                                <input type="hidden" value="<?php echo $socialmedia['userInfoID'] ?>"
                                                    name="userInfoID">
                                                <button class="btn btn-danger" style="margin-bottom: 15px; margin-top: 15px;"
                                                    name="btnDelete">Delete</button>
                                            </form>
                                            <a href="view.php?userInfoID=<?php echo $socialmedia['userInfoID'] ?>">
