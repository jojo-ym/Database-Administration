...
if (isset($_POST['btnDelete'])) {
    $idako = $_POST['idako'];
    $deleteQuery = "DELETE FROM usersinfo WHERE userInfoID= '$idako'";
                                ...
                                <div class="container-fluid d-flex justify-content-start">
                                    <div class="row mt-5 w-100">
                                        <div class="col-12 text-start">
                                            ...
                                            <form method="post">
                                                <input type="hidden" value="<?php echo $socialmedia['userInfoID'] ?>" name="idako">
                                                <button class="btn btn-danger" style="margin-bottom: 20px; margin-top: 15px;" name="btnDelete">Delete</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
